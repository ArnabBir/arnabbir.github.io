...
const CONFIG = {
  "id": "myrocks-1",
  "title": "MyRocks LSM-Tree Database Storage Engine Serving Facebook s Social Graph (1)",
  "subtitle": "Interactive simulation + deep dive",
  "badge": "Storage Engines • LSM Trees at Scale",
  "accent": "amber",
  "heroIcon": "HardDrive",
  "paper": {
    "filename": "MyRocks LSM-Tree Database Storage Engine Serving Facebook_s Social Graph (1).pdf"
  },
...
export default function Myrocks1Simulation() {
